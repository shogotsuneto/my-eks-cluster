...
module "eks_managed_node_group" {
  ...
  use_name_prefix = false # don't create a unique name beginning with the `name`
  ...
  cluster_endpoint           = module.eks.cluster_endpoint                   # modified
  cluster_auth_base64        = module.eks.cluster_certificate_authority_data # modified
  cluster_service_ipv4_cidr  = null                                          # modified
  ...
  # vpc_security_group_ids is specified above
  ...
  iam_role_use_name_prefix      = try(each.value.iam_role_use_name_prefix, var.eks_managed_node_group_defaults.iam_role_use_name_prefix, false) # modified
  ...
  # Security group
  create_security_group          = try(each.value.create_security_group, var.eks_managed_node_group_defaults.create_security_group, false) # modified
